...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	public class RigidbodyFirstPersonController : MonoBehaviour
	{
		...
		private void Update ()
		{
			...
			if (Input.GetKeyDown (TransScene.Present.Controller.A) && !m_Jump) {
				m_Jump = true;
			}
		}
		...
		private Vector2 GetInput ()
		{
			...
			Vector2 input = new Vector2 {
				x = TransScene.Present.Controller.GetAxis ("Horizontal"),
				y = TransScene.Present.Controller.GetAxis ("Vertical")
			};
