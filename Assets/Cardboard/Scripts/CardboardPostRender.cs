...
public class CardboardPostRender : MonoBehaviour
{
	...
	// For OnRenderObject() sequencing
	public LinkedList<IRenderSeq> renderers = new LinkedList<IRenderSeq> ();
	...
	void OnRenderObject ()
	{
		...
		// Render other gameobjects
		foreach (IRenderSeq render in renderers)
			render.OnSeqRenderObject();
	}
